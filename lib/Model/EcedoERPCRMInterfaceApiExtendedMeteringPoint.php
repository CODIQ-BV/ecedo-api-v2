...
/**
 * EcedoERPCRMInterfaceApiExtendedMeteringPoint Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcedoERPCRMInterfaceApiExtendedMeteringPoint implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ecedo.ERP.CRM.Interface.Api.ExtendedMeteringPoint';
    ...
    protected static $swaggerTypes = [
        'supplier_ean' => 'string',
        'supplier_localized' => 'string',
        'physical_capacity' => 'string',
        'energy_delivery_status' => 'string',
        'energy_delivery_status_localized' => 'string',
        'metering_method' => 'string',
        'metering_method_localized' => 'string',
        'allocation_method' => 'string',
        'allocation_method_localized' => 'string',
    ...
    protected static $swaggerFormats = [
        'supplier_ean' => null,
        'supplier_localized' => null,
        'physical_capacity' => null,
        'energy_delivery_status' => null,
        'energy_delivery_status_localized' => null,
        'metering_method' => null,
        'metering_method_localized' => null,
        'allocation_method' => null,
        'allocation_method_localized' => null,
        'contracted_capacity' => 'int32',
        'profile' => null,
        'cap_tar_code' => null,
        'cap_tar_day_tariff' => 'double',
    ...
    protected static $attributeMap = [
        ...
        'supplier_localized' => 'SupplierLocalized',
        'physical_capacity' => 'PhysicalCapacity',
        'energy_delivery_status' => 'EnergyDeliveryStatus',
        'energy_delivery_status_localized' => 'EnergyDeliveryStatusLocalized',
        'metering_method' => 'MeteringMethod',
        'metering_method_localized' => 'MeteringMethodLocalized',
        'allocation_method' => 'AllocationMethod',
        'allocation_method_localized' => 'AllocationMethodLocalized',
    ...
    protected static $setters = [
        ...
        'supplier_localized' => 'setSupplierLocalized',
        'physical_capacity' => 'setPhysicalCapacity',
        'energy_delivery_status' => 'setEnergyDeliveryStatus',
        'energy_delivery_status_localized' => 'setEnergyDeliveryStatusLocalized',
        'metering_method' => 'setMeteringMethod',
        'metering_method_localized' => 'setMeteringMethodLocalized',
        'allocation_method' => 'setAllocationMethod',
        'allocation_method_localized' => 'setAllocationMethodLocalized',
        'contracted_capacity' => 'setContractedCapacity',
        'profile' => 'setProfile',
    ...
    protected static $getters = [
        ...
        'supplier_localized' => 'getSupplierLocalized',
        'physical_capacity' => 'getPhysicalCapacity',
        'energy_delivery_status' => 'getEnergyDeliveryStatus',
        'energy_delivery_status_localized' => 'getEnergyDeliveryStatusLocalized',
        'metering_method' => 'getMeteringMethod',
        'metering_method_localized' => 'getMeteringMethodLocalized',
        'allocation_method' => 'getAllocationMethod',
        'allocation_method_localized' => 'getAllocationMethodLocalized',
        'contracted_capacity' => 'getContractedCapacity',
        'profile' => 'getProfile',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['supplier_localized'] = isset($data['supplier_localized']) ? $data['supplier_localized'] : null;
        $this->container['physical_capacity'] = isset($data['physical_capacity']) ? $data['physical_capacity'] : null;
        $this->container['energy_delivery_status'] = isset($data['energy_delivery_status']) ? $data['energy_delivery_status'] : null;
        $this->container['energy_delivery_status_localized'] = isset($data['energy_delivery_status_localized']) ? $data['energy_delivery_status_localized'] : null;
        $this->container['metering_method'] = isset($data['metering_method']) ? $data['metering_method'] : null;
        $this->container['metering_method_localized'] = isset($data['metering_method_localized']) ? $data['metering_method_localized'] : null;
        $this->container['allocation_method'] = isset($data['allocation_method']) ? $data['allocation_method'] : null;
        $this->container['allocation_method_localized'] = isset($data['allocation_method_localized']) ? $data['allocation_method_localized'] : null;
        $this->container['contracted_capacity'] = isset($data['contracted_capacity']) ? $data['contracted_capacity'] : null;
     ...
     * Sets supplier_ean
     *
     * @param string $supplier_ean De EAN van de huidige leverancier van de aansluiting
     *
     * @return $this
     */
    ...
    /**
     * Gets supplier_localized
     *
     * @return string
     */
    public function getSupplierLocalized()
    {
        return $this->container['supplier_localized'];
    }

    /**
     * Sets supplier_localized
     *
     * @param string $supplier_localized De naam van de huidige leverancier van de aansluiting
     *
     * @return $this
     */
    public function setSupplierLocalized($supplier_localized)
    {
        $this->container['supplier_localized'] = $supplier_localized;

        return $this;
    }

    /**
     * Gets physical_capacity
     *
     * @return string
     */
    public function getPhysicalCapacity()
    {
        return $this->container['physical_capacity'];
    }

    /**
     * Sets physical_capacity
     *
     * @param string $physical_capacity De fysieke capaciteit van de aansluiting (alleen bij grootverbruikaansluitingen)
     *
     * @return $this
     */
    public function setPhysicalCapacity($physical_capacity)
    {
        $this->container['physical_capacity'] = $physical_capacity;

        return $this;
    }

    /**
     * Gets energy_delivery_status
     *
     * @return string
     */
    public function getEnergyDeliveryStatus()
    {
        return $this->container['energy_delivery_status'];
    }

    /**
     * Sets energy_delivery_status
     *
     * @param string $energy_delivery_status Leveringsstatus van de aansluiting
     *
     * @return $this
     */
    public function setEnergyDeliveryStatus($energy_delivery_status)
    {
        $this->container['energy_delivery_status'] = $energy_delivery_status;

        return $this;
    }

    /**
     * Gets energy_delivery_status_localized
     *
     * @return string
     */
    public function getEnergyDeliveryStatusLocalized()
    {
        return $this->container['energy_delivery_status_localized'];
    }

    /**
     * Sets energy_delivery_status_localized
     *
     * @param string $energy_delivery_status_localized Nederlandse vertaling van de leveringsstatus van de aansluiting
     *
     * @return $this
     */
    public function setEnergyDeliveryStatusLocalized($energy_delivery_status_localized)
    {
        $this->container['energy_delivery_status_localized'] = $energy_delivery_status_localized;
     ...
     *
     * @param string $metering_method Manier waarop de aansluiting bemeterd is
     *
     * @return $this
     */
    ...
    /**
     * Gets metering_method_localized
     *
     * @return string
     */
    public function getMeteringMethodLocalized()
    {
        return $this->container['metering_method_localized'];
    }

    /**
     * Sets metering_method_localized
     *
     * @param string $metering_method_localized Nederlandse vertaling van de manier waarop de aansluiting bemeterd is
     *
     * @return $this
     */
    public function setMeteringMethodLocalized($metering_method_localized)
    {
        $this->container['metering_method_localized'] = $metering_method_localized;
     ...
     *
     * @param string $allocation_method Manier waarop de aansluiting wordt gealloceerd
     *
     * @return $this
     */
    ...
    /**
     * Gets allocation_method_localized
     *
     * @return string
     */
    public function getAllocationMethodLocalized()
    {
        return $this->container['allocation_method_localized'];
    }

    /**
     * Sets allocation_method_localized
     *
     * @param string $allocation_method_localized Nederlandse vertaling van de manier waarop de aansluiting wordt gealloceerd
     *
     * @return $this
     */
    public function setAllocationMethodLocalized($allocation_method_localized)
    {
        $this->container['allocation_method_localized'] = $allocation_method_localized;

        return $this;
    }

    /**
     * Gets contracted_capacity
     *
     * @return int
     */
    public function getContractedCapacity()
    {
        return $this->container['contracted_capacity'];
    }

    /**
     * Sets contracted_capacity
     *
     * @param int $contracted_capacity De contract-capaciteit van de aansluiting (alleen bij grootverbruikaansluitingen)
     *
     * @return $this
     */
    public function setContractedCapacity($contracted_capacity)
    {
        $this->container['contracted_capacity'] = $contracted_capacity;
