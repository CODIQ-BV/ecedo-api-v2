<?php
/**
 * EcedoERPCRMInterfaceApiChangeAllocationMethodPostData
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * EcedoERPCRMInterfaceApiChangeAllocationMethodPostData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcedoERPCRMInterfaceApiChangeAllocationMethodPostData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ecedo.ERP.CRM.Interface.Api.ChangeAllocationMethodPostData';
    ...
    const ALLOCATION_METHOD_SMA = 'SMA';
    const ALLOCATION_METHOD_PRF = 'PRF';
    const ALLOCATION_METHOD_TMT = 'TMT';
    ...
    {
        return [
            self::ALLOCATION_METHOD_SMA,
            self::ALLOCATION_METHOD_PRF,
            self::ALLOCATION_METHOD_TMT,
        ];
    }
    ...
    {
        $allowedValues = $this->getAllocationMethodAllowableValues();
        if (!is_null($allocation_method) && !in_array($allocation_method, $allowedValues, true)) {
