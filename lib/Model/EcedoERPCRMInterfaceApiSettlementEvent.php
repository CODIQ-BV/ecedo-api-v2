...
/**
 * EcedoERPCRMInterfaceApiSettlementEvent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcedoERPCRMInterfaceApiSettlementEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ecedo.ERP.CRM.Interface.Api.SettlementEvent';
    ...
    protected static $swaggerTypes = [
        'settlement_invoice_status' => 'string',
        'settlement_invoice_status_localized' => 'string',
    ...
    protected static $swaggerFormats = [
        'settlement_invoice_status' => null,
        'settlement_invoice_status_localized' => null,
    ...
    protected static $attributeMap = [
        'settlement_invoice_status' => 'SettlementInvoiceStatus',
        'settlement_invoice_status_localized' => 'SettlementInvoiceStatusLocalized',
    ...
    protected static $setters = [
        'settlement_invoice_status' => 'setSettlementInvoiceStatus',
        'settlement_invoice_status_localized' => 'setSettlementInvoiceStatusLocalized',
    ...
    protected static $getters = [
        'settlement_invoice_status' => 'getSettlementInvoiceStatus',
        'settlement_invoice_status_localized' => 'getSettlementInvoiceStatusLocalized',
    ...
    const SETTLEMENT_INVOICE_STATUS_COLLECT_DATA = 'CollectData';
    const SETTLEMENT_INVOICE_STATUS_CALCULATE_METER_READINGS = 'CalculateMeterReadings';
    const SETTLEMENT_INVOICE_STATUS_WAIT_FOR_CALCULATION = 'WaitForCalculation';
    const SETTLEMENT_INVOICE_STATUS_CALCULATE_INVOICE = 'CalculateInvoice';
    const SETTLEMENT_INVOICE_STATUS_PROCESS_INVOICE_LOGS = 'ProcessInvoiceLogs';
    const SETTLEMENT_INVOICE_STATUS_ADVANCE_PAYMENT_CALCULATION = 'AdvancePaymentCalculation';
    const SETTLEMENT_INVOICE_STATUS_VALIDATE_INVOICE = 'ValidateInvoice';
    const SETTLEMENT_INVOICE_STATUS_GENERATE_EXACT_EXPORT = 'GenerateExactExport';
    const SETTLEMENT_INVOICE_STATUS_CHECK_EXACT_EXPORT_PROCESSING = 'CheckExactExportProcessing';
    const SETTLEMENT_INVOICE_STATUS_GENERATE_INVOICE_LETTER = 'GenerateInvoiceLetter';
    const SETTLEMENT_INVOICE_STATUS_GENERATE_BATCH_INVOICE_LETTER = 'GenerateBatchInvoiceLetter';
    const SETTLEMENT_INVOICE_STATUS_COLLECTED = 'Collected';
    const SETTLEMENT_INVOICE_STATUS_CREATE_COLLECTIVE_INVOICE = 'CreateCollectiveInvoice';
    const SETTLEMENT_INVOICE_STATUS_WAIT_FOR_COLLECTING = 'WaitForCollecting';
    const SETTLEMENT_INVOICE_STATUS_GENERATE_CHILD_INVOICE_LETTER = 'GenerateChildInvoiceLetter';
    const SETTLEMENT_INVOICE_STATUS_WAIT_FOR_FINALIZE_CHILD_INVOICE = 'WaitForFinalizeChildInvoice';
    const SETTLEMENT_INVOICE_STATUS_FLOW_FINISHED = 'FlowFinished';
    const SETTLEMENT_INVOICE_STATUS_OTHER = 'Other';
     ...
     * @return string[]
     */
    public function getSettlementInvoiceStatusAllowableValues()
    {
        return [
            self::SETTLEMENT_INVOICE_STATUS_COLLECT_DATA,
            self::SETTLEMENT_INVOICE_STATUS_CALCULATE_METER_READINGS,
            self::SETTLEMENT_INVOICE_STATUS_WAIT_FOR_CALCULATION,
            self::SETTLEMENT_INVOICE_STATUS_CALCULATE_INVOICE,
            self::SETTLEMENT_INVOICE_STATUS_PROCESS_INVOICE_LOGS,
            self::SETTLEMENT_INVOICE_STATUS_ADVANCE_PAYMENT_CALCULATION,
            self::SETTLEMENT_INVOICE_STATUS_VALIDATE_INVOICE,
            self::SETTLEMENT_INVOICE_STATUS_GENERATE_EXACT_EXPORT,
            self::SETTLEMENT_INVOICE_STATUS_CHECK_EXACT_EXPORT_PROCESSING,
            self::SETTLEMENT_INVOICE_STATUS_GENERATE_INVOICE_LETTER,
            self::SETTLEMENT_INVOICE_STATUS_GENERATE_BATCH_INVOICE_LETTER,
            self::SETTLEMENT_INVOICE_STATUS_COLLECTED,
            self::SETTLEMENT_INVOICE_STATUS_CREATE_COLLECTIVE_INVOICE,
            self::SETTLEMENT_INVOICE_STATUS_WAIT_FOR_COLLECTING,
            self::SETTLEMENT_INVOICE_STATUS_GENERATE_CHILD_INVOICE_LETTER,
            self::SETTLEMENT_INVOICE_STATUS_WAIT_FOR_FINALIZE_CHILD_INVOICE,
            self::SETTLEMENT_INVOICE_STATUS_FLOW_FINISHED,
            self::SETTLEMENT_INVOICE_STATUS_OTHER,
        ];
    }
    ...
    {
        $this->container['settlement_invoice_status'] = isset($data['settlement_invoice_status']) ? $data['settlement_invoice_status'] : null;
        $this->container['settlement_invoice_status_localized'] = isset($data['settlement_invoice_status_localized']) ? $data['settlement_invoice_status_localized'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSettlementInvoiceStatusAllowableValues();
        if (!is_null($this->container['settlement_invoice_status']) && !in_array($this->container['settlement_invoice_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'settlement_invoice_status', must be one of '%s'",
    ...
    /**
     * Gets settlement_invoice_status
     *
     * @return string
     */
    public function getSettlementInvoiceStatus()
    {
        return $this->container['settlement_invoice_status'];
    }

    /**
     * Sets settlement_invoice_status
     *
     * @param string $settlement_invoice_status settlement_invoice_status
     *
     * @return $this
     */
    public function setSettlementInvoiceStatus($settlement_invoice_status)
    {
        $allowedValues = $this->getSettlementInvoiceStatusAllowableValues();
        if (!is_null($settlement_invoice_status) && !in_array($settlement_invoice_status, $allowedValues, true)) {
        ...
        $this->container['settlement_invoice_status'] = $settlement_invoice_status;

        return $this;
    }

    /**
     * Gets settlement_invoice_status_localized
     *
     * @return string
     */
    public function getSettlementInvoiceStatusLocalized()
    {
        return $this->container['settlement_invoice_status_localized'];
    }

    /**
     * Sets settlement_invoice_status_localized
     *
     * @param string $settlement_invoice_status_localized settlement_invoice_status_localized
     *
     * @return $this
     */
    public function setSettlementInvoiceStatusLocalized($settlement_invoice_status_localized)
    {
        $this->container['settlement_invoice_status_localized'] = $settlement_invoice_status_localized;
