...
/**
 * EcedoERPCRMInterfaceApiMeterReadingCollectionEvent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcedoERPCRMInterfaceApiMeterReadingCollectionEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ecedo.ERP.CRM.Interface.Api.MeterReadingCollectionEvent';
    ...
    protected static $swaggerTypes = [
        ...
        'collection_status_localized' => 'string',
    ...
    protected static $swaggerFormats = [
        ...
        'collection_status_localized' => null,
    ...
    protected static $attributeMap = [
        ...
        'collection_status_localized' => 'CollectionStatusLocalized',
    ...
    protected static $setters = [
        ...
        'collection_status_localized' => 'setCollectionStatusLocalized',
    ...
    protected static $getters = [
        ...
        'collection_status_localized' => 'getCollectionStatusLocalized',
    ...
    const COLLECTION_STATUS_WAIT_FOR_REQUEST_DATE = 'WaitForRequestDate';
    const COLLECTION_STATUS_WAIT_FOR_P4_READING = 'WaitForP4Reading';
    const COLLECTION_STATUS_WAIT_FOR_METER_READING = 'WaitForMeterReading';
    const COLLECTION_STATUS_CALCULATE_METER_READING = 'CalculateMeterReading';
    const COLLECTION_STATUS_FLOW_FINISHED = 'FlowFinished';
    const COLLECTION_STATUS_OTHER = 'Other';
     ...
     * @return string[]
     */
    public function getCollectionStatusAllowableValues()
    {
        return [
            self::COLLECTION_STATUS_WAIT_FOR_REQUEST_DATE,
            self::COLLECTION_STATUS_WAIT_FOR_P4_READING,
            self::COLLECTION_STATUS_WAIT_FOR_METER_READING,
            self::COLLECTION_STATUS_CALCULATE_METER_READING,
            self::COLLECTION_STATUS_FLOW_FINISHED,
            self::COLLECTION_STATUS_OTHER,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['collection_status_localized'] = isset($data['collection_status_localized']) ? $data['collection_status_localized'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCollectionStatusAllowableValues();
        if (!is_null($this->container['collection_status']) && !in_array($this->container['collection_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'collection_status', must be one of '%s'",
    ...
    {
        $allowedValues = $this->getCollectionStatusAllowableValues();
        if (!is_null($collection_status) && !in_array($collection_status, $allowedValues, true)) {
    ...
    /**
     * Gets collection_status_localized
     *
     * @return string
     */
    public function getCollectionStatusLocalized()
    {
        return $this->container['collection_status_localized'];
    }

    /**
     * Sets collection_status_localized
     *
     * @param string $collection_status_localized collection_status_localized
     *
     * @return $this
     */
    public function setCollectionStatusLocalized($collection_status_localized)
    {
        $this->container['collection_status_localized'] = $collection_status_localized;
